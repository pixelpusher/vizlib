...
export function makeVisualiser(
  ...
  props = { title: "LivePrinter", debug: false, delay: true, 
    travelColor: 0xea4488, travelOpacity: 0.8,
    extrudeColor: 0x4488ea, extrudeOpacity: 0.7,
  ...
  export_funcs.resetScene = function() {
    ...
    printGroup.add(lineSegmentsExtrude);
    export_funcs.vizevents.travelGeometry = travelLine.geometry;
    export_funcs.vizevents.extrudeGeometry  = extrudeLine.geometry;
  };
